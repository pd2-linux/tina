...
//      return tr->discard(dev, block, nsect);
    ...
    case READ:
        ...
        total_read_sector = total_read_sector + nsect;
        total_read_time = total_read_time + timeuse;
#endif
        total_read_counter++;
    ...
    case WRITE:
        ...
        total_write_sector = total_write_sector + nsect;
        total_write_time = total_write_time + timeuse;
#endif
        total_write_counter++;
...
{
    int   good_block_ratio_flag;
    int  type;


    /* ªÒ»°card_line÷µ */
    type = script_parser_fetch("nand0_para", "good_block_ratio", &good_block_ratio_flag,sizeof(int));
