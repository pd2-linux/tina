...
void app_avk_display_main_menu(void)
{
    ...
    printf("    %d  => AVK Send Get Element Attributes Command", APP_AVK_MENU_GET_ELEMENT_ATTR);
    printf("    %d  => AVK Get capabilities", APP_AVK_MENU_GET_CAPABILITIES);
    printf("    %d  => AVK Register Notification", APP_AVK_MENU_REGISTER_NOTIFICATION);
    printf("    %d  => Quit\n", APP_AVK_MENU_QUIT);
}
