...
/**
 * Open secure memory adapter, initialize communication context.
 * This API will setup drm protection, i.e, some of the hardwares
 * can access secure memory, such as DE/VE.
 *
 * @return: returns 0 on success or errorno on error.
 */
 ...
 * This API will shutdown drm protection, i.e, all of the hardwares
 * cannot access secure memory anymore.
 *
 * @return: returns 0 on success or errorno on error.
 */
...
/**
 * Setup VE as protected mode, so VE can access secure memory.
 *
 * @return: returns 0 on success or errorno on error.
 */
...
/**
 * Showdown VE from protected mode, VE cannot access secure
 * memory anymore.
 *
 * @return: returns 0 on success or errorno on error.
 */
