...
#if (CONFIG_CHIP == OPTION_CHIP_1689 || CONFIG_CHIP == OPTION_CHIP_1701 || CONFIG_CHIP == OPTION_CHIP_1663)
...
enum ion_heap_type {
    ...
    (CONFIG_CHIP == OPTION_CHIP_1689) || (CONFIG_CHIP == OPTION_CHIP_1701) || (CONFIG_CHIP == OPTION_CHIP_1663) || \
...
#if (CONFIG_PRODUCT == OPTION_PRODUCT_PAD && CONFIG_CHIP == OPTION_CHIP_1639) || CONFIG_CHIP == OPTION_CHIP_1663 || CONFIG_CHIP == OPTION_CHIP_1689 || CONFIG_CHIP == OPTION_CHIP_1701
