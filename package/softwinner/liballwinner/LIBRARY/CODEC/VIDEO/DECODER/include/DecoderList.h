...
void DecoderListAdd(struct DecoderListNodeS *new, struct DecoderListS *list);

void DecoderListAddBefore(struct DecoderListNodeS *new, struct DecoderListNodeS *pos);

void DecoderListAddAfter(struct DecoderListNodeS *new, struct DecoderListNodeS *pos);

void DecoderListAddTail(struct DecoderListNodeS *new, struct DecoderListS *list);
