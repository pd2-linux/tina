...
// YCC: full range BT.601 
typedef struct VencH264VideoSignal
{
	// range of video_format is 0 to 7
	// 0: Component; 1: PAL; 2: NTSC; 3: SECAM; 4: MAC; 6 and 7: Reserved
	// Default set 5: Unspecified video format; 
	unsigned char video_format; 
	
	unsigned char full_range_flag;
	
	// range of colour_primaries is 0 to 8
	// 1: BT.709-5; 5: BT.601-6 625; 6: BT.601-6 525; others: see H.264 Draft
