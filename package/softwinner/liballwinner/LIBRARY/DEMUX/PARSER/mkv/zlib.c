...
int inflate_table(codetype type, unsigned short * lens, unsigned int codes,code ** table, unsigned int * bits, unsigned short * work)
{
...
void inflate_fast(z_stream * strm, unsigned int start)
{
	...
	unsigned int op;			// code bits, operation, extra bits, or window position, window bytes to copy 
